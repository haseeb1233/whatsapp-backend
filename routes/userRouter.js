...
userRouer.get(
  ...
  async function (req, res) {
    ...
    if (fetch_user) {
      ...
      res.redirect(`../frontend/chatpage.html?avtar=${req.user.avtar}&id=${fetch_user._id}&myName=${fetch_user.name}&role=${fetch_user.role}&token=${token}&refreshToken=${refreshToken}`)
      console.log("here");
